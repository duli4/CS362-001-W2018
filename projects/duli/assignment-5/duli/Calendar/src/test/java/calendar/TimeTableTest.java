	 ...
	 @Test
	  public void test02()  throws Throwable  {
			...
			//Construct a new Appointment object with the initial data
				...
				LinkedList<Appt> listAppts_1 = new LinkedList<Appt>();
				listAppts_1.add(appt);
				listAppts_1.add(appt3);
				listAppts_1.add(appt4);
				listAppts_1.add(appt5);
				assertEquals(listAppts.get(0),appt);
				assertEquals(4,listAppts_1.size());
				assertNotNull(timeTable.deleteAppt(listAppts_1,appt5));
				assertEquals(3,listAppts_1.size());
	 }
